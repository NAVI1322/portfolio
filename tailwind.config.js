    ...
    theme: {
    	...
    	extend: {
    		fontFamily: {
    			...
    			'subheading': ['Tektur', 'sans-serif'],
    			'tech': ['Share Tech Mono', 'monospace'],
    			'cyber': ['Chakra Petch', 'sans-serif'],
    			'retro': ['Silkscreen', 'cursive'],
    			'future': ['Russo One', 'sans-serif'],
    			'elegant': ['Montserrat Subrayada', 'sans-serif'],
    			'base': ['Rajdhani', 'sans-serif'],
    			'title': ['Tourney', 'cursive'],
    			'accent': ['Neonderthaw', 'cursive'],
    			'matrix': ['Share Tech Mono', 'monospace'],
    			'neon': ['Play', 'sans-serif'],
    		},
    		colors: {
